import { simpleWriter } from '../esm/index.js';
import * as fs from 'fs';
import * as path from 'path';
import { fileURLToPath } from 'url';
import rimraf from 'rimraf';

const generatedFileContents = 'Generated by @static-pages/file-provider test runner. This file can be safely deleted.';
